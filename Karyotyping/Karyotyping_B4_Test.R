...
path2alignedbam <- "/mnt/uow-pathology-dun/lucy/analyses/BEBIC_analysis/CellLineB/demuxed/by_sample/B4_Test/"
output_dir <- "/external/analyses/20241104-BEBIC_Karyotyping/ACE/B4_Test"
